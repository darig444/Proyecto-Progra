document.getElementById('menuToggle').addEventListener('click', function() {
    ...
    navMobile.classList.toggle('active'); // Alterna la clase 'active'
});
...
function registerUser(event) {
    ...
    // Recuperamos los usuarios de localStorage (o un arreglo vacío si no hay usuarios)
...
function updateNav() {
 ...
 welcomeMessage.textContent = `Bienvenido, ${loggedInUser}`; // Mostrar nombre del
usuario
